...
function printPepo() {
    ...
    imgContainer.innerHTML = `<img width="150" height="150" src="Rondini 2.jpg"><img width="150" height="150" src="Zucchini 500x500zugeschnitten.jpg"><img width="150" height="150" src="lilpumkemon.jpg">`
...
function printMaxima() {
    ...
    imgContainer.innerHTML = `<img width="150" height="150" src="112620.jpg"><img width="150" height="150" src="Solor.jpg"><img width="150" height="150" src="091780.jpg">`
...
function printMoschata() {
    ...
    imgContainer.innerHTML = `<img width="150" height="150" src="133340.jpg"><img width="150" height="150" src="Mieluna 500x500 2.jpg"><img width="150" height="150" src="Tromba d Albegna.jpg">`
