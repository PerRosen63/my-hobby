...
function printPepo() {
    ...
    imgContainer.innerHTML = `<img width="150" height="150" src="./images/Rondini 2.jpg"><img width="150" height="150" src="./images/Zucchini 500x500zugeschnitten.jpg"><img width="150" height="150" src="./images/lilpumkemon.jpg">`
...
function printMaxima() {
    ...
    imgContainer.innerHTML = `<img width="150" height="150" src="./images/112620.jpg"><img width="150" height="150" src="./images/Solor.jpg"><img width="150" height="150" src="./images/091780.jpg">`
...
function printMoschata() {
    ...
    imgContainer.innerHTML = `<img width="150" height="150" src="./images/133340.jpg"><img width="150" height="150" src="./images/Mieluna 500x500 2.jpg"><img width="150" height="150" src="./images/Tromba d Albegna.jpg">`
    textDivStart.innerHTML = `<p>Curcubita moschata kallas ibland för myskpumpa. Dessa sorter betraktas inte sällan som lite lyxigare. Köttet har en finare textur, smaken är ofta nötig och kärnhusen mindre. Kärnorna som är små på myskpumporna kan man absolut provsmaka. Har man tur är de riktigt goda. Chansen är större om de inte frukterna hunnit mogna helt, dvs tidigt efter skörd. Detta gäller för övrigt andra sorters vinterpumpor med lite mindre frön. Testa!</p><p>Myskpumporna är lite svårare att odla i vårt land eftersom de har en längre utvecklingstid. Man behöver sätta igång tidigt, men samtidigt skydda de små plantorna mot frost.</p><p>Hos oss är nog den mest kända myskpumpan Butternut, men det finns många andra utsökta sorter. En lustig variant av Butternut är Tromboncini, en smal "trumpetpumpa" som kan bli över en och en halv meter lång.</p>`;
}
